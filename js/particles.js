    ...
    if(pJS.interactivity.events.onhover.enable && pJS.interactivity.status == 'mousemove'){
      ...
      if(dist_mouse <= pJS.interactivity.modes.grab.distance){
        ...
        if(opacity_line > 0){
          ...
          //pJS.canvas.ctx.strokeStyle = 'rgba('+color_line.r+','+color_line.g+','+color_line.b+','+opacity_line+')';
          pJS.canvas.ctx.strokeStyle = 'rgba('+Math.round(color_line.r+208*Math.max(0.0,(opacity_line-0.3)/0.3))+','+Math.round(color_line.g-126*Math.max(0.0,(opacity_line-0.3)/0.3))+','+Math.round(color_line.b-25*Math.max(0.0,(opacity_line-0.3)/0.3))+','+opacity_line+')';
          pJS.canvas.ctx.lineWidth = pJS.particles.line_linked.width*opacity_line*2;
	  //pJS.canvas.ctx.shadowBlur = Math.floor(p1.opacity*20);
	  //pJS.canvas.ctx.shadowColor = 'rgba('+Math.round(color_line.r+208*Math.max(0.0,(opacity_line-0.3)/0.3))+','+Math.round(color_line.g-126*Math.max(0.0,(opacity_line-0.3)/0.3))+','+Math.round(color_line.b-25*Math.max(0.0,(opacity_line-0.3)/0.3))+','+opacity_line+')';
	//pJS.canvas.ctx.filter = 'blur('+Math.floor(p1.opacity*2)+'px)';
          //pJS.canvas.ctx.lineCap = 'round'; /* performance issue */
